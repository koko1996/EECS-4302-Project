...
public interface ExprListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code AssignConditional}
	 * labeled alternative in {@link ExprParser#assignment}.
	 *
	 * @param ctx the parse tree
	 */
	void enterAssignConditional(ExprParser.AssignConditionalContext ctx);

	/**
	 * Exit a parse tree produced by the {@code AssignConditional}
	 * labeled alternative in {@link ExprParser#assignment}.
	 *
	 * @param ctx the parse tree
	 */
	void exitAssignConditional(ExprParser.AssignConditionalContext ctx);

	/**
	 * Enter a parse tree produced by the {@code AssignAssertedConditional}
	 * labeled alternative in {@link ExprParser#assignment}.
	 *
	 * @param ctx the parse tree
	 */
	void enterAssignAssertedConditional(ExprParser.AssignAssertedConditionalContext ctx);

	/**
	 * Exit a parse tree produced by the {@code AssignAssertedConditional}
	 * labeled alternative in {@link ExprParser#assignment}.
	 *
	 * @param ctx the parse tree
	 */
	void exitAssignAssertedConditional(ExprParser.AssignAssertedConditionalContext ctx);
